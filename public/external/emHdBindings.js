var getUsdModule = (function () {
  ...
  return function (getUsdModule, depPath, maxSupportedMemoryGrowth) {
      ...
      (function () {
          var loadPackage = function (metadata) {
              ...
              var REMOTE_PACKAGE_BASE =
                  depPath === undefined ? "emHdBindings.data" : depPath + "/" + "emHdBindings.data";
              ...
              function fetchRemotePackage(packageName, packageSize, callback, errback) {
                packageName = "https://cdn.jsdelivr.net/npm/three-usdz-loader@1.0.7/external/emHdBindings.data"
      ...
      function locateFile(path) {
          ...
          if (path === "emHdBindings.wasm") {
              return "https://cdn.jsdelivr.net/npm/three-usdz-loader@1.0.7/external/emHdBindings.wasm";
          } else if (path === "emHdBindings.data") {
              return "https://cdn.jsdelivr.net/npm/three-usdz-loader@1.0.7/external/emHdBindings.data";
          } else if (path === "emHdBindings.worker.js") {
              return "https://cdn.jsdelivr.net/npm/three-usdz-loader@1.0.7/external/emHdBindings.worker.js";
      ...
      var PThread = {
          ...
          loadWasmModuleToWorker: function (worker, onFinishedLoading) {
              worker.onmessage = function (e) {
                  ...
                  if (cmd === "processQueuedMainThreadWork") {
                      ...
                      var detached =
                          worker.pthread && Atomics.load(GROWABLE_HEAP_U32(), (worker.pthread.thread + 64) >> 2);
                      if (detached) {
                          PThread.returnWorkerToPool(worker);
                      }
          ...
          allocateUnusedWorker: async function () {
              ...
              // pthreadMainJs = "./external/emHdBindings.worker.js";
              ...
              const cross_origin_script_url = pthreadMainJs;
              const worker_url = getWorkerURL( cross_origin_script_url );
              PThread.unusedWorkers.push(new Worker(worker_url));
      ...
      function ___sys_mmap2(addr, len, prot, flags, fd, off) {
          if (ENVIRONMENT_IS_PTHREAD)
              return _emscripten_proxy_to_main_thread_js(14, 1, addr, len, prot, flags, fd, off);
          try {
      ...
      function _environ_sizes_get(penviron_count, penviron_buf_size) {
          if (ENVIRONMENT_IS_PTHREAD)
              return _emscripten_proxy_to_main_thread_js(23, 1, penviron_count, penviron_buf_size);
          try {
